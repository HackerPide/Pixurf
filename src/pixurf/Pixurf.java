...
public class Pixurf extends javax.swing.JFrame {
    ...
    double threeManBoost1Crouch(double wframe){
        return wframe + povH - hBoxH2 - hBoxCH;
    }
    ...
    double fourManBoost1Crouch(double wframe){
        return wframe + povH - 2*hBoxH2 - hBoxCH;
    }
    ...
    double fiveManBoost1Crouch(double wframe){
        return wframe + povH - 3*hBoxH2 - hBoxCH;
    }
    ...
    private void initComponents() {
        ...
        tickCheckBox.setText("Calculate 64-tick only");
    ...
    private void calcButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcButtonActionPerformed
        if (!wfField.getText().isEmpty()
                && !lhField.getText().isEmpty()
                && !hhField.getText().isEmpty()){
            
            resetTextAreas();
            select = tickCheckBox.isSelected();
            
            wframeTemp = checkDouble(wfField.getText());
            lhTemp = checkDouble(lhField.getText());
            hhTemp = checkDouble(hhField.getText());         
            
            if (wframeTemp != null && lhTemp != null && hhTemp != null){
                tempS = ""; 
